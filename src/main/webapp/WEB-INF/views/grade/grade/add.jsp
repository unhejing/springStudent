                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <form action="grade/grade/save_${cmd}.do" method="post" class="form-horizontal" role="form"
                                ...
                                <input type="hidden" name="id" <c:if test="${not empty grade.id}">value='${grade.id}'</c:if>>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" autocomplete="off" id="name" name="name" class="required form-control" <c:if test="${not empty grade.name}">value='${grade.name}'</c:if>>
                                    </div>
                                </div>
