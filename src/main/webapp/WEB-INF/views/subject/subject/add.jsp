                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <form action="subject/subject/save_${cmd}.do" method="post" class="form-horizontal" role="form"
                                  id="admin-add-form">
                                <input type="hidden" value="${cmd}" id="cmd"/>
                                <input type="hidden" name="id" <c:if test="${not empty subject.id}">value='${subject.id}'</c:if>>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" autocomplete="off" id="name" name="name" class="required form-control" <c:if test="${not empty subject.name}">value='${subject.name}'</c:if>>
                                    </div>
                                </div>
