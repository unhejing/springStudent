...
// Class that all other grade will inherit from
function Class() { }
...
Grid.mixin({
	...
	// List of grade that were defined by the caller of the API in some way
...
var DayTableMixin = FC.DayTableMixin = {
	...
	// Generates the default HTML intro for any row. User grade should override
